...
20) P8X32A should now be running on BeMicroCV, indicated by a single green LED (cog0)

21) Install your Propeller Plug into the header as shown in the .PNG file
